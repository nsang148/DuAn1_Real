...
public class ThongKeRepository {
    ...
    public List<ThongKeResponse> getAll() {
        ...
        String SELECT = "select NGAYTHANHTOAN, sum(hdct.SOLUONG) as [So luong], sum(hdct.SOLUONG)* sum(hdct.DONGIA) as [Tong tien] from HOADON hd join HOADONCHITIET hdct on hd.Id = hdct.ID_HOADON group by NGAYTHANHTOAN";
        try {
    ...
    public List<ThongKeResponse> search(String dateBD, String dateKT) {
        List<ThongKeResponse> list = new ArrayList<>();
        String select = "select NGAYTHANHTOAN, sum(hdct.SOLUONG) as [So luong], sum(hdct.SOLUONG)* sum(hdct.DONGIA) as [Tong tien]  from HOADON hd join HOADONCHITIET hdct on hd.Id = hdct.ID_HOADON where NGAYTHANHTOAN between ? and ? group by NGAYTHANHTOAN";
